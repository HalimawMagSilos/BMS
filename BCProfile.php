...
// Fetch barangay official profile information
try {
    $stmt = $pdo->prepare("
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    try {
        ...
        header("Location: BCProfile.php?update_success=1");
        exit();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    try {
        ...
        header("Location: BCProfile.php?message_sent=1");
        exit();
...
<body class="bg-gray-100 flex">
    <aside id="sidebar" class="sidebar bg-green-500 text-white w-64 min-h-screen p-6 fixed inset-y-0 left-0 transform -translate-x-full overflow-y-auto">
        ...
        <nav>
            <ul class="space-y-6">
                ...
                <li><a href="BCApplication.php" class="block py-3 px-4 rounded hover:bg-green-600 text-lg">Barangay Clearance Applications</a></li>
    ...
    <main id="main-content" class="main-content flex-grow p-8 ml-0">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mb-8">
            ...
            <form action="BCProfile.php" method="POST">
                <div class="mb-4">
    ...
    <div id="messageModal" class="modal">
        <div class="modal-content">
            ...
            <form action="BCProfile.php" method="POST" enctype="multipart/form-data">
                <div class="mb-4">

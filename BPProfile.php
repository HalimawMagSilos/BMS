...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    try {
        ...
        header("Location: BPProfile.php?update_success=1");
        exit();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    try {
        ...
        header("Location: BPProfile.php?message_sent=1");
        exit();
...
<body class="bg-gray-100 flex">
    ...
    <main id="main-content" class="main-content flex-grow p-8 ml-0">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mb-8">
            ...
            <form action="BPProfile.php" method="POST">
                <div class="mb-4">
    ...
    <div id="messageModal" class="modal">
        <div class="modal-content">
            ...
            <form action="BPProfile.php" method="POST" enctype="multipart/form-data">
                <div class="mb-4">

...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['application_id'])) {
    ...
    try {
        ...
        header('Location: BCApplication.php');
        exit;
...
<style>
    ...
    width: 250px; /* or whatever pixel width you want the sidebar to be */
}
...
@media (min-width: 768px) {
    #main-content.active {
        margin-left: 250px; /* or the same pixel value as the sidebars width */
    }
}
...
<body class="bg-gray-100 flex">
    <aside id="sidebar" class="sidebar bg-green-500 text-white w-64 min-h-screen p-6 fixed inset-y-0 left-0 overflow-y-auto">
        <div class="text-center mb-8">
            <img alt="Barangay Clearance Department Logo" class="mx-auto mb-4" height="100"
                src="https://storage.googleapis.com/a1aa/image/FIM565KosH2Eo5Lqps2r-iwpSdYyPwD4FcVD0OtHXMk.jpg" width="100" />
            <h1 class="text-3xl font-bold">Barangay Clearance Dept</h1>
        </div>
        <nav>
            <ul class="space-y-6">
                <li><a href="BCHome.php" class="block py-3 px-4 rounded hover:bg-green-600 text-lg">Home</a></li>
                <li><a href="BCProfile.php" class="block py-3 px-4 rounded hover:bg-green-600 text-lg">Profile</a></li>
                <li><a href="BCApplication.php" class="block py-3 px-4 rounded hover:bg-green-600 text-lg">Barangay Clearance
                        Applications</a></li>
                <li><a href="BCSettings.php" class="block py-3 px-4 rounded hover:bg-green-600 text-lg">Settings</a></li>
        ...
        <div id="review-modal" class="modal">
            <div class="modal-content">
                ...
                <form id="review-form" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2">Complaints</label>
                        <div id="complaints_list" class="border p-2 rounded-lg">
                            <p>No complaints</p>
                        </div>
                    </div>

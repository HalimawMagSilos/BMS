        ...
        if ($user && password_verify($current_password, $user['password'])) {
            if ($new_password === $confirm_password) {
                if (validatePassword($new_password)) {
                    ...
                    header("Location: ResidentSettings.php?success=1");
                    exit();
                } else {
...
<html>
<head>
    <title>Resident Dashboard - Change Password</title>
...
<body class="bg-gray-100 flex">
    ...
    <aside id="sidebar" class="sidebar bg-blue-500 text-white w-64 min-h-screen p-6 fixed inset-y-0 left-0 transform -translate-x-full overflow-y-auto">
        <div class="text-center mb-8">
            <img alt="Resident Dashboard Logo" class="mx-auto mb-4" height="100" src="https://storage.googleapis.com/a1aa/image/ZlS8 sK0YNai5MGRJForAKu4_20-Z3HeENsCVvw_X1Vk.jpg" width="100">
